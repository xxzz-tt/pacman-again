...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        "*** YOUR CODE HERE ***"
        # slide 13
        self.qValue[(state, action)] = self.alpha * (reward + self.discount * self.computeValueFromQValues(nextState)) \
                                       + (1 - self.alpha) * self.getQValue(state, action) # help what to multiply by
